...
B_comb=[B_4,B_4,B_16(1:4:end),B_16(2:4:end),B_16(3:4:end),B_16(4:4:end)];
N_comb=[N_4,N_4,N_16(1:4:end),N_16(2:4:end),N_16(3:4:end),N_16(4:4:end)];
...
B_comb=[B_1,B_1,pre_416_B(1:4:end),pre_416_B(2:4:end),pre_416_B(3:4:end),pre_416_B(4:4:end)];
N_comb=[N_1,N_1,pre_416_N(1:4:end),pre_416_N(2:4:end),pre_416_N(3:4:end),pre_416_N(4:4:end)];
input_x=[B_comb;N_comb];
input_y=[ones(length(B_comb),1);zeros(length(N_comb),1)];
...
B_test=[B_test_4,B_test_4,B_test_16(1:4:end),B_test_16(2:4:end),B_test_16(3:4:end),B_test_16(4:4:end)];
N_test=[N_test_4,N_test_4,N_test_16(1:4:end),N_test_16(2:4:end),N_test_16(3:4:end),N_test_16(4:4:end)];
...
B_test=[B_test_1,B_test_1,test_416_B(1:4:end),test_416_B(2:4:end),test_416_B(3:4:end),test_416_B(4:4:end)];
N_test=[N_test_1,N_test_1,test_416_N(1:4:end),test_416_N(2:4:end),test_416_N(3:4:end),test_416_N(4:4:end)];
